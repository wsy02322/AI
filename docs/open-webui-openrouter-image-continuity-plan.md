...
> **状态**：聊天路径错误模式 / 连续性备忘。**独立官网级 Studio** 见 `docs/open-webui-image-studio-plan.md`（提案），不要把本文 A/C 补丁冒充 Studio。  
> **最后更新**：2026-09-04（加 Studio 指针）  
...
- 现网指引与重建：`docs/open-webui-rebuild-archive.md` §3.3 / §5
