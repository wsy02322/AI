...
> **探针**：2026-09-04 升级前复核，`https://micropigeon.com`，OWUI **仍 0.11.0**。官方 **0.11.3** 已确认，见 `docs/open-webui-upgrade-0113-plan.md`（digest 换完改本行）。  
...
| 容器名 | `open-webui` |
| 镜像 | **当前**钉死 digest `e97bf9531916`（OWUI 0.11.0）。**已确认**换官方 `v0.11.3` 再钉新 digest（`docs/open-webui-upgrade-0113-plan.md`）。**不要**漂 `:main` / `:latest`。无 OpenAI/Google Realtime 钥匙时 **不换** Realtime 镜像 |
...
| `docs/open-webui-upgrade-0113-plan.md` | **已确认**官方 0.11.3（VPS 换镜像 + 仓库脚本重放） |
