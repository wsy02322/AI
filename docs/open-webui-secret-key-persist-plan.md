...
关联：`docs/SPEC.md`（ST-OPS-*）、`AGENTS.md`、`docs/open-webui-rebuild-archive.md`
...
3. 重建容器时保持：entrypoint `/custom/entrypoint.sh`、`127.0.0.1:8080`、`api_configs` 未改。**当前**镜像官方 **v0.11.3**（image id `129f4038ec70`；RepoDigest `sha256:751b617714b91e4cfd0186a509c72480c858e012976103b09a30dad053c36175`）。不要漂 `:latest`。回滚目标仍是旧钉 `e97bf9531916`。  
