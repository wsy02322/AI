...
| 上次 `verify_stack.py` | **2026-09-01 契约面**：Banner v3、chips=0、Follow-up 关、Fable marker、19 public 全绿；picker **23**（契约 19，多 4 个未批准 active，见 archive §3.6）。更早 2026-08-22 全绿时 Banner 仍为双条 v2 |
