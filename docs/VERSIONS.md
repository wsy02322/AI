...
| ST-14 质量基线 | **2026-09-05 EVAL-B**：隐含时效 42/42；误搜 0/21；Fetch 答案 11/14（黄，Anthropic）。实例指纹未变。建议 Filter Fetch 指引，未改实例。见 `docs/open-webui-text-web-search-eval-b-results.md` |
