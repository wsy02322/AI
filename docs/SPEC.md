...
| ST-17 | xAI 类薄 Filter Search+Fetch **`engine=native`**（网页+X）。OpenAI/Google 仍 Exa。Grok 须能引用 x.com。**W5 全模型 X 未确认不上**。不要和 ST-11/12/14/16 混号 |
...
- **已落地**：聊天四格 + 路线 S；ST-14 薄 Web Search（质量**已收口**）；Live **L1**；**ST-16 高德路线 Tool 已过门**；**ST-17 Grok native / X 已过门**  
